...
The last structure is "simple" to parse in a C-like language -
...
This is a good davit to get into in general, since some IDEs give you hover-tips:
...
if you're doing serious numerics, you'll want to paralellise on the CPU / GPU, which is much easier
in C/C++/Fortran than it is in fancy modern languages.
